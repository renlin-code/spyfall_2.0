...
export default {
    ...
    methods: {
        async shareApp() {
            await this.navigatorInstance.share({
            title: "Spyfall",
            text: "",
            url: `${this.urlToShare}`
            });
